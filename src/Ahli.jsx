        ...
        <div className="all-cards">
          ...
          {/* <Link to="/rincianbayar"> */}
            <div className="expert-card">
              <img src="assets/images/expert1.png" alt="Dr. Syarif, Sp.KK" className="expert-photo" />
          ...
          <Link to="/rincianbayar">
            <div className="expert-card">
              <img src="assets/images/expert2.png" alt="dr. Emy Kusumaningsih, Sp.DV" className="expert-photo" />
              <div className="expert-info">
                <h3>dr. Emy Kusumaningsih, Sp.DV</h3>
                <p className="specialty">Spesialis Dermatovenereologi Estetika</p>
                <div className="card-details">
                  <div className="experience">
                    <span>📅</span>
                    <span>7 Tahun</span>
          ...
          {/* <Link to="/rincianbayar"> */}
            <div className="expert-card">
              <img src="assets/images/expert3.png" alt="dr. Michael Jackson Sp.KK" className="expert-photo" />
              <div className="expert-info">
          ...
          <Link to="/rincianbayar">
            <div className="expert-card">
              <img src="assets/images/expert5.png" alt="dr. Anatasya, Sp.KK" className="expert-photo" />
              <div className="expert-info">
          ...
          <Link to="/rincianbayar">
            <div className="expert-card">
              <img src="assets/images/expert6.png" alt="dr. Clara, Sp.KK" className="expert-photo" />
              <div className="expert-info">
          ...
          {/* <Link to="/rincianbayar"> */}
            <div className="expert-card">
              <img src="assets/images/expert7.png" alt="dr. Hana, Sp.KK" className="expert-photo" />
              <div className="expert-info">
                <h3>dr. Hana, Sp.KK</h3>
                <p className="specialty">Spesialis Kulit Ibu Hamil, Stretch Mark</p>
                <div className="card-details">
                  <div className="experience">
                    <span>📅</span>
                    <span>3 Tahun</span>
          ...
          {/* <Link to="/rincianbayar"> */}
            <div className="expert-card">
              <img src="assets/images/expert 8.png" alt="dr. Citra, Sp.KK" className="expert-photo" />
              <div className="expert-info">
          ...
          <Link to="/rincianbayar">
            <div className="expert-card">
              <img src="assets/images/expert9.png" alt="dr. Erlina, Sp.KK" className="expert-photo" />
              <div className="expert-info">
          ...
          <Link to="/rincianbayar">
            <div className="expert-card">
              <img src="assets/images/expert10.png" alt="dr. Andriana, Sp.KK" className="expert-photo" />
              <div className="expert-info">
                <h3>dr. Andriana, Sp.KK</h3>
                <p className="specialty">Spesialis Kulit Kusam & Penuaan Dini</p>
                <div className="card-details">
                  <div className="experience">
                    <span>📅</span>
                    <span>5 Tahun</span>
